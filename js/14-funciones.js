...
/* 
  ...
  Se puede llamara la función antes de su definición debido al hoisting, es  decir que se "elevan" en el contexto de ejecución.
...
/* Hacer una funcion que muestre un saludo con*/
...
/* 
  Crear una función que de la bienvenida a un usuario personalizando su nombre y que muestre un mensaje de invitado, si no se tiene el nombre de usuario
*/
...
function despedida(nombre = 'Ariel') {
  return `Adios ${nombre}`
}
...
/* 
  ...
  Las funciones flecha no necesita la palabra return en su estructira mas simple (una sola linea)
